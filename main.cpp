...
void Mandelbrot::updateImage(double zoom, double offsetX, double offsetY, sf::Image& image) const
{
...
#if PARALLELIZE==OPENMP
   updateImageSlice(zoom, offsetX, offsetY, image, 0, IMAGE_HEIGHT);
#elif PARALLELIZE==CPP
   ...
   updateImageSlice(zoom, offsetX, offsetY, image, 0, IMAGE_HEIGHT);
    ...
    std::cout << "Rendering took " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << "ms\n";
}
                ...
                case sf::Event::KeyPressed:
                    ...
                    switch (event.key.code) {
                        ...
                        case sf::Keyboard::D:
                            offsetX += 40 * zoom;
                            break;
			case sf::Keyboard::Return://rerender
			    break;
                        default: 
                            stateChanged = false;
                            break;
